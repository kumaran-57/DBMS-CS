...
-- 12. Average UserID for a Specific Course
SELECT AVG(UserID) AS AvgUserID
FROM Enrollments
WHERE CourseTitle = 'Cyber Security Basics';

-- 13. Count Courses by Each Trainer for Users Born After 2003
...
-- 14. Max UserID for a Course by a Specific Trainer
SELECT MAX(UserID) AS MaxUserID
FROM Enrollments
WHERE Trainer = 'Dr. Kevin Mitnick';

-- 15. Sum EnrollmentIDs for Users Whose First Name Starts with 'J'
...
-- 16. List Users with Full Name in Uppercase and Age
SELECT
